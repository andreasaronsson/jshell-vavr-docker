...
/usr/lib/jvm/java-9-jdk/bin/jlink --module-path lib:jdk-9/jmods:./mods --output jre --add-modules nu.aron.vavrjshell --limit-modules nu.aron.vavrjshell --compress 2 --no-header-files --strip-debug
