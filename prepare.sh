...
URL=https://download.java.net/java/early_access/alpine/40/binaries/openjdk-10-ea+40_linux-x64-musl_bin.tar.gz
curl $URL | tar xz
...
/usr/lib/jvm/java-9-jdk/bin/jlink --module-path lib:jdk-10/jmods:./mods --output jre --add-modules nu.aron.vavrjshell --limit-modules nu.aron.vavrjshell --compress 2 --no-header-files --no-man-pages --strip-debug
